...
const Sponsors = () => {
  return (
    <div className='bg-patt-grid p-4 sm:p-8 lg:p-[4rem] w-full text-center'>
    <span className='font-orbitron text-white text-2xl sm:text-3xl lg:text-4xl'>Our Sponsors</span>

    <div className='p-4 sm:p-8 lg:p-[4rem] min-h-[28rem]'>
    ...
    <div className='p-4 sm:p-6 lg:p-[3rem] min-h-[28rem]'>
        <div className='text-center mb-4 sm:mb-8'>
